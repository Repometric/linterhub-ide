...
describe('LinterhubArgs class', function () {
    let obj = new LinterhubArgs("cli-path", LinterhubTypes.Mode.dotnet);
    ...
    it('activate request generation', function () {
        assert.equal(obj.activate("linter", "project-path"), cli_path + " --mode=activate --project=project-path --active=true --linter=linter");
    });
    ...
    it('deactivate request generation', function () {
        assert.equal(obj.deactivate("linter", "project-path"), cli_path + " --mode=activate --project=project-path --active=false --linter=linter");
    });
    ...
    it('ignoreWarning request generation', function () {
        assert.equal(obj.ignoreWarning({ file: null, error: null, line: null }, "project-path"), cli_path + " --mode=ignore --project=project-path");
        assert.equal(obj.ignoreWarning({ file: "file", error: null, line: null }, "project-path"), cli_path + " --mode=ignore --project=project-path --file=file");
        assert.equal(obj.ignoreWarning({ file: "file", error: "test", line: null }, "project-path"), cli_path + " --mode=ignore --project=project-path --error=test --file=file");
        assert.equal(obj.ignoreWarning({ file: "file", error: null, line: 10 }, "project-path"), cli_path + " --mode=ignore --project=project-path --file=file --line=10");
    });
